...
- **Slow Tag + eyedropper** — free-text tagging dialog with live autocomplete (Space), middle-click tagging, number keys 1–5 for combos, pixel color picker, transparency badges.
