...
class SettingsDialog(QDialog):
    ...
    def _build_general_tab(self) -> QWidget:
        ...
        self._thumb_size.setRange(100, 500)
        ...
        # HAREM_FORK: wheel scroll multiplier for large thumbnails.
        from ..harem.scroll import parse_scroll_multiplier

        self._scroll_speed = QDoubleSpinBox()
        self._scroll_speed.setRange(0.25, 10.0)
        self._scroll_speed.setSingleStep(0.25)
        self._scroll_speed.setDecimals(2)
        self._scroll_speed.setSuffix("×")
        self._scroll_speed.setValue(
            parse_scroll_multiplier(self._db.get_setting("scroll_speed_multiplier"))
        )
        self._scroll_speed.setToolTip(
            "Extra wheel speed on top of auto-scaling for thumbnail size "
            f"(at 400px thumbnails, 1× already scrolls 2× vs the 200px baseline)."
        )
        form.addRow("Scroll speed multiplier:", self._scroll_speed)
    ...
    def _apply(self) -> None:
        ...
        self._db.set_setting("scroll_speed_multiplier", str(self._scroll_speed.value()))
