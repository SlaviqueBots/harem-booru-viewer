...
class ThumbnailGrid(QScrollArea):
    ...
    def wheelEvent(self, event: QWheelEvent) -> None:
        ...
        if delta > 30:
            ...
            # HAREM_FORK: optional scroll multiplier (1× = stock super().wheelEvent).
            from ..harem.scroll import apply_wheel_multiplier

            if not apply_wheel_multiplier(self, event, thumb_size=THUMB_SIZE):
